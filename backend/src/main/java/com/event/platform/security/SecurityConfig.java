package com.event.platform.security;

import com.event.platform.service.CustomUserDetailsService;
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		http
			...
			.authorizeHttpRequests(auth -> auth
				...
				.requestMatchers(HttpMethod.GET, "/api/attendees/**").hasAuthority("ROLE_ADMIN")
